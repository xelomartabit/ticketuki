...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handlePromocionNotFound(PromocionNotFoundException ex, HttpServletRequest request) {
        log.warn("Promoción no encontrada: {}", ex.getMessage());
