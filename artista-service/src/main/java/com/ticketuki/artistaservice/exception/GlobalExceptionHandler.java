...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleArtistaNotFound(ArtistaNotFoundException ex, HttpServletRequest request) {
        log.warn("Artista no encontrado: {}", ex.getMessage());
